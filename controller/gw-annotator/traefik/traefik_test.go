...
func TestIsAnnotated(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			configMode: gateway.Ingress,
			annotations: map[string]interface{}{
				gateway.CustomRequestHeadersKey: "",
			},
			expectedOutput: false,
		},
		{
			...
			configMode: gateway.Ingress,
			annotations: map[string]interface{}{
				gateway.CustomRequestHeadersKey: "k1:v1||k2:v2",
			},
			expectedOutput: false,
		},
		{
			...
			configMode: gateway.Ingress,
			annotations: map[string]interface{}{
				gateway.CustomRequestHeadersKey: fmt.Sprintf("k1:v1||%s:%s||k2:v2", gateway.L5DHeader, "value"),
			},
			expectedOutput: true,
		},
	}
...
func TestGenerateAnnotationPatch(t *testing.T) {
	annotationKey := gateway.CustomRequestHeadersKey
			...
			obj: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"metadata": map[string]interface{}{
						"namespace": "test-ns",
						"annotations": map[string]interface{}{
							gateway.CustomRequestHeadersKey: "k1:v1||k2:v2:extra_colon",
						},
					},
					"spec": map[string]interface{}{
						"backend": map[string]interface{}{
